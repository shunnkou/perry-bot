...
lint: ## check style with flake8
	flake8 Exploding_Springfield tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source Exploding_Springfield -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov\index.html

docs: ## generate Sphinx HTML documentation, including API docs
	del /f /q docs\Exploding_Springfield.rst
	del /f /q docs\modules.rst
	sphinx-apidoc -o docs Exploding_Springfield
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
